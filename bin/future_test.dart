...
void main() {
  final doMe = doFutures();
  print('doFutures returned');
  doMe.then((_) => print('do Future completed'));
}

Future<void> doFutures() async {
  final Completer done = Completer<void>();
  print('doFutures: started');
  Future.delayed(const Duration(seconds: 10), () {
    print('delayed 10');
    done.complete();
  });
  Future.delayed(const Duration(seconds: 5), () => print('delayed 5'));
  print('about to await');
  await Future.delayed(const Duration(seconds: 7), () => print('delayed 7'));
