...
) ENGINE=InnoDB AUTO_INCREMENT=20904 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `member` VALUES (20903,6411,'member@noojee.com.au',NULL,'voniee04RNhUCoA3SmzBHSchhMXouZ0g9wpLw5B6ZA4ODDNLLTY1x6VpIGypJa0vOu4Fevdlw0a6c4zJCZAA5KhiaTTD1zsSvhsjRor8EQK6kBpCciniu23DkcXIIBgq',NULL,'2022-01-14 09:40:58','2022-01-14',1,NULL,'2022-01-14 08:40:58','2022-01-14 08:40:58');
...
CREATE TABLE `packageOwner` (
  ...
  KEY `fk_packageOwner_team_idx` (`ownerMemberId`),
  ...
  CONSTRAINT `fk_packageOwner_team` FOREIGN KEY (`ownerMemberId`) REFERENCES `team` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
) ENGINE=InnoDB AUTO_INCREMENT=6412 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `publisher` VALUES (6411,'noojee.com.au','a','inTrial',NULL,'2022-01-16','pro','member@noojee.com.au','accounts@noojee.com.au','2022-01-14',NULL,'month',500,'fixed',1,'Australia','2022-01-14 08:40:58','2022-01-14 08:40:58');
...
-- Dump completed on 2022-01-14  9:34:44
